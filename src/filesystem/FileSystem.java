...
public abstract class FileSystem {
    ...
    public abstract void writeFileContent(List<String> arguments) throws FileDoesNotExistException, InvalidArgumentException, IOException;
    public abstract String listFiles();
    public abstract String listFilesSorted();
    public abstract String countWords(String name) throws FileDoesNotExistException, IOException;
    public abstract String countLines(String name) throws FileDoesNotExistException, IOException;
    public abstract void removeFile(String name) throws FileDoesNotExistException,IOException;
    public abstract void removeContent(List<String> arguments) throws FileDoesNotExistException, InvalidArgumentException, IOException;
